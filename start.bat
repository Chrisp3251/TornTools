...
setlocal
cd /d "%~dp0"
title TornTools v0.6.0 Backend

echo TornTools v0.6.0 Backend
echo Dashboard: http://127.0.0.1:8765
echo Travel Intelligence: http://127.0.0.1:8765/static/travel-intelligence.html
...
".venv\Scripts\python.exe" -m uvicorn equipment_quality_runtime:app --host 127.0.0.1 --port 8765 --reload
pause
