...
(function(){
  ...
  const css=document.createElement('style');css.textContent=`.best-trip-plan{margin:0 0 14px;padding:12px 14px;border:1px solid rgba(117,183,255,.32);border-radius:10px;background:rgba(117,183,255,.045)}.best-plan-head span,.best-plan-head strong,.best-plan-head small{display:block}.best-plan-head span{font-size:9px;font-weight:900;letter-spacing:.11em;color:#75b7ff}.best-plan-head strong{font-size:18px;margin-top:3px}.best-plan-head small{font-size:10px;color:var(--muted,#9ba1ad);margin-top:3px}.best-plan-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;margin-top:10px}.best-plan-grid>div{padding:8px 9px;border:1px solid var(--border,#343943);border-radius:8px;background:rgba(0,0,0,.12)}.best-plan-grid span,.best-plan-grid strong{display:block}.best-plan-grid span{font-size:9px;text-transform:uppercase;letter-spacing:.06em;color:var(--muted,#9ba1ad)}.best-plan-grid strong{font-size:13px;margin-top:3px}@media(max-width:900px){.best-plan-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}`;
  document.head.appendChild(css);
  const ui=document.createElement('script');ui.src='/static/travel-ui-v2.js?v=3';document.head.appendChild(ui);
})();
